...
export default function Index() {
  ...
  const [lineopt, baropt, createopt, incomeopt] = useMemo(() => {
    // 亮灯率 ， 市电，绿电, 发电量
    let { lightRates, useds, creates, incomes } = isObject(datas) ? datas : {};
    ...
    let lopt = {
      ...
      dataset: {
        ...
        source: [lightRates?.x, lightRates?.y],
        sourceHeader: false,
      },
    };
    let bopt = {
      // 用电量
      series: [
        { type: "bar", seriesLayoutBy: "row", stack: "ec" },
  ...
  const getpoint = async (rid, x, y) => {
    try {
      if (!Number.isInteger(Number.parseInt(rid)))
        return message.warning("路灯Id无效");
        ...
        <Mainwrap>
          <div className="left">
            <div className="titleUp">
              <div className="titlehd overew">平台概览</div>
            ...
            <div className="content">
              ...
              <div className="chart">
              <div className="chartTitle titlehd">近7日发电量统计(Wh)</div>
              <div className="chartWrap">
                <Ichart {...createopt} />
              </div>
              </div>
            ...
            <div className="up">
              <div className="shownum">
                ...
                <div className="data">
                  ...
                  <span className="num">
                    {datas?.lightRate &&
                    typeof parseFloat(datas?.lightRate) == "number"
                      ? `${parseFloat(datas?.lightRate)?.toFixed(2)}%`
                      : "--"}
                  </span>
                </div>
              </div>
              <div className="shownum">
                ...
                <div className="data">
                  ...
                  <span className="num">
                    {datas?.lightUpNum ? datas?.lightUpNum : "--"}
                  </span>
                </div>
              </div>
              <div className="shownum">
                ...
                <div className="data">
                  ...
                  <span className="num">
                    {datas?.todayEUsed ? datas?.todayEUsed : "--"}
                  </span>
                </div>
              </div>
              <div className="shownum">
          ...
          <div className="shownum">
            ...
            <div className="middler">
              ...
              {datas?.locationInfos?.map((l) => (
                <Point
                  left={l.x}
                  top={l.y}
                  key={l.lightName}
                  data-descr={l.lightName}
                  onClick={() => getpoint(l.lightId, l.x, l.y)}
                ></Point>
              ))}
              {info && (
                <TitP

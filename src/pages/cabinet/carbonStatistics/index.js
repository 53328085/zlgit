...
export default function Index() {
    ...
    const columnstable = [
        ...
        { title: i18t("cabinet", "CircuitName"), dataIndex: 'name', key: 'name', align: "center", },
        { title: i18t("cabinet", "CarbonEmission", { param: '(tCO₂)' }), dataIndex: 'value', key: 'value', align: "center", },
    ...
    // const CItitle = (
    //     <div className='custTitle'>
    //         <span><CustTransO text="Classificationratio" ns="cabinet" />（tCO₂）</span>
    //         <Radiogroup options={options}
    //             defaultValue={1}
        ...
        <Pagecount bgcolor="#eeeff3" pd={0}>
            <Mainbox laptop={laptop}>
                <div className='up' key="up" >
                    ...
                    <Card name={<CustTransO ns="cabinet" text="Annualee" param="(tCO₂)" />} laptop={laptop} title="" value={Quota.annualEmissionEquivalent} yoy={Quota.annualEmissionEquivalentYoy} key="b" />
                    <Card title={<CustTransO ns="cabinet" text="Annualce" param="(tCO₂)" />} laptop={laptop} value={Quota.annualResidualCarbonEmission} yoy={Quota.annualResidualCarbonEmissionPercent} key="c" />
                    {/*  <Cdivider type="h" borderColor="#bcbcbc" /> */}
                    <Card title={<CustTransO ns="cabinet" text="directe" param="(tCO₂)" />} laptop={laptop} value={Quota.directEmission} yoy={Quota.directEmissionPercent} key="d" />
                    <Card title={<CustTransO ns="cabinet" text="indirecte" param="(tCO₂)" />} laptop={laptop} value={Quota.indirectEmission} yoy={Quota.indirectEmissionPercent} key="e" />
                </div>
                <div className='center' key="center">
                    <div className='imgbox'>
                        <img src={projectImg.current || imgsrcs['cabinet']} alt="" />
                    </div>

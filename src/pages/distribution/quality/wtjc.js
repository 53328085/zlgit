...
import {columns, columns2, columns3, columns4, columns5, columns6, columns7, columns8, columns9} from './columns'
  ...
  return (
    <Mainbox>
        <Item key="ec">
          ...
          <div key={nanoid()}>
               <UserTable columns={columns3} dataSource={abciData} istheme="theme" rowKey={nanoid()} ></UserTable>
          </div>
          <div key={nanoid()}>
               <UserTable columns={columns4} dataSource={zfliData} istheme="theme" rowKey={nanoid()} ></UserTable>
          </div> 
          </Item>

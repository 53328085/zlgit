...
import {ztfxcolumns} from './columns'
...
export default function Index({projectId, day, sn}) {
  ...
  const getData = async() => {
      ...
      let {success, data} = await  PowerQuality.ZTFX(body)
  ...
  return (
    <Mainbox>
       <UserTable columns={ztfxcolumns} dataSource={datas} istheme="theme" rowKey={nanoid()} loading={loading} scroll={{

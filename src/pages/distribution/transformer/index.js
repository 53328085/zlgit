...
export default function Index() {
  ...
  const type = [{name:'电压(V)',value:0},{name:'电流(A)',value:1},{name:'总有功功率',value:2},{name:'总无功功率',value:3},{name:'总视在功率',value:4},{name:'总功率因数',value:5},{name:'总负荷',value:6},{name:'总负荷率',value:7}]
  const choose = (i)=>{
    console.log(i)
    setActiveIndex(i)
  } 
            ...
            <div className={style.chartArea}>
              <div className={style.totalCharts}>
                <div className={style.chartsheader}>
                  ...
                  {/* <img src={columnpng} style={{width:30,height:17,padding:'0 10px'}}></img> */}
                    {type.map(item=>(<div key={item.value} style={{width:112}}>{item.name}</div>))}
                  </div>
                  <div className={style.totaltype}>
                   <div style={{width:86,textAlign:'center'}}>日</div>
                   <div style={{width:86,textAlign:'center'}}>月</div>
                   <div style={{width:86,textAlign:'center'}}>年</div>
                  </div>
                </div>

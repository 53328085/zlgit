...
import GasSolution from './firesolution'
...
export default function Index() {
  ...
  console.log(solutionPropsList)
  const ElectricSolution = ()=> solutionPropsList.map((item, index) => <ElecSolution {...item} key={index} getPriceSolution={getPriceSolution}></ElecSolution>)
  
  const PricingCom = {
    electricity: ElectricSolution,
    water: WaterSolution,
    gas: GasSolution,
    coal: CoalSolution
  }
  let Com = PricingCom[value]

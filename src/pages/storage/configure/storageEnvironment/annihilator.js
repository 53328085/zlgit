  ...
  const columns =[
    {
      ...
      render:(_, record) =>{
        <Space>
          <span style={{textDecoration:'underline', color:'#237ae4'}}>重启</span>
          <span style={{textDecoration:'underline', color:'#237ae4'}}>参数下发</span>
          <span style={{textDecoration:'underline', color:'#237ae4'}}>编辑</span>

...
export default forwardRef(function Index({lineId=0,initId=0, projectId=1, update=()=>{}}, ref){
...
const  {tableProps,  search, refresh} = useAntdTable(getUnBind, {
 ...
 //   manual:true,
  ...
  return (
    <div>
          <CModal title="自定义设备添加"   onOk={onOk}   width={1074} mold="cust"    ref={mRef}>
            <Bindwrap>
              ...
              <div className='inwrap'>
               ...
               <div className='tbwrap'> 
                   <Form form={form} layout="inline">
                        <Form.Item label="未选中的设备" name="alike">
                        <Serach   onSearch={submit} placeholder="请输入设备名称或编号"></Serach>
                        </Form.Item>
                   </Form>                  
               ...
               <Form form={formed} layout="inline">
                        <Form.Item label="已选中的设备" name="alike">
                        <Serach   onSearch={searched.submit}  placeholder="请输入设备名称或编号"></Serach>
                        </Form.Item>
                   </Form>

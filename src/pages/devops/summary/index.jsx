  ...
  return (
    <Pagecount bgcolor="#eeeff3" pd={0}>
      <Mainbox>
        ...
        <Modal mold='cust' title={<Bluecolumn name="告警信息" bac="#FF4D4F"/>}
          closable={false} open={openAlarm} footer={[
            <Button key="submit" style={{ backgroundColor: '#FF4D4F',border:'none', color: '#fff', width: 96, height: 32 }} onClick={onOk}>
              确定
            </Button>,
          ]} width={980}>
          <UserTable columns={columns} dataSource={alarmData} rowKey="id" scroll={{y:320}} />
        </Modal>
        <div className='left'>
